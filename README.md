...
- [Item 16: In public classes, use accessor methods, not public fields](chapter-3.md#item-16-in-public-classes-use-accessor-methods-not-public-fields)
- [Item 17: Minimize mutability](chapter-3.md#item-17-minimize-mutability)
- [Item 18: Favor composition over inheritance](chapter-3.md#item-18-favor-composition-over-inheritance)
- [Item 19: Design and document for inheritance or else prohibit it](chapter-3.md#item-19-design-and-document-for-inheritance-or-else-prohibit-it)
- [Item 20: Prefer interfaces to abstract classes](chapter-3.md#item-20-prefer-interfaces-to-abstract-classes)
- [Item 21: Design interfaces for posterity](chapter-3.md#item-21-design-interfaces-for-posterity)
- [Item 22: Use interfaces only to define types](chapter-3.md#item-22-use-interfaces-only-to-define-types)
- [Item 23: Prefer class hierarchies to tagged classes](chapter-3.md#item-23-prefer-class-hierarchies-to-tagged-classes)
- [Item 24: Favor static member classes over nonstatic](chapter-3.md#item-24-favor-static-member-classes-over-nonstatic)
- [Item 25: Limit source files to a single top-level class](chapter-3.md#item-25-limit-source-files-to-a-single-top-level-class)