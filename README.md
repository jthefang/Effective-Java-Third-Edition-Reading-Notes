...
## [Chapter 2: Creating and Destroying Objects](src/chapter-2.md)

- [Item 1: Consider static factory methods instead of constructors](src/chapter-2.md#item-1-consider-static-factory-methods-instead-of-constructors)
